...
<p align="center">
  ...
  URL Cleaner и Text Inspector — в браузере. X-Ray — серверный прокси без логов и хранения.<br>
  Без аккаунтов.
</p>
...
- Домен-специфичные правила (Amazon, YouTube, AliExpress / aliexpress.ru, Bilibili и др.)
...
- Длинные URL в интерфейсе автоматически сокращаются с многоточием — кликните, чтобы развернуть
...
### PWA
Устанавливается как приложение через меню браузера «Добавить на главный экран», работает офлайн (кроме X-Ray).
